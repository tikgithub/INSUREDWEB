            ...
            <form autocomplete="off" method="POST" action="{{route('InsuranceFlowController.storeInputFromCustomer')}}" enctype="multipart/form-data">
                ...
                <fieldset class="border notosanLao">
                    ...
                    <div class="p-2">
                        ...
                        <div class="mb-3 row">
                            <div class="col-sm-6 text-center">
                                <img class="ms-2 rounded" src="{{asset($inputData->rear_image)}}" style="width: auto; height: 100px;" alt="" srcset="">
                            </div>
                            <div class="col-sm-6 align-self-center">
                        ...
                        <div class="mb-3 row">
                            <div class="col-md-12">
                                ...
                                <textarea readonly name="" id="" rows="7" class="form-control bg-white">Lorem ipsum dolor sit amet consectetur adipisicing elit. Obcaecati deserunt est, esse quam dolorem at aspernatur magni earum officia architecto dolor inventore reprehenderit hic repudiandae suscipit ut quasi. Placeat, reiciendis.</textarea>
                            </div>
                        </div>
                        ...
                        <div class="mb-3 row">
                            <div class="col-md-12 d-flex justify-content-center">
                                <button type="submit" class="btn bg-blue text-white"><i class="bi bi-cash-stack"></i> ຊຳລະເງິນ</button>
                            </div>
                        </div>
                    </div>
