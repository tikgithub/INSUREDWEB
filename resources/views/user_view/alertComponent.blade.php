...
@case('WAIT_FOR_PAYMENT')
    <div class="alert fs-4 fw-bold alert-info" role="alert">
        <i class="bi bi-cash-stack me-2"></i> ກາລຸນາຢືນຢັນການສັ່ງຊື້
    </div>
@break

@case('WAIT_FOR_APPROVED')
    <div class="alert fs-4 fw-bold alert-warning" role="alert">
        <i class="bi bi-clock-history me-2"></i> ກາລຸນາລໍຖ້າລາຍກຳລັງຢູ່ໃນການກວດສອບ
    </div>
@break

@case('APPROVED_OK')
    <div class="alert fs-4 fw-bold alert-success" role="alert">
