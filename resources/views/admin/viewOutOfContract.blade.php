...
@section('content')
    ...
    <div class="row">
        <div class="col-md-12">
            <table class="notosanLao fs-4">
                <tr>
                    <td width="100">ເລກທີສັນຍາ: </td><td width="200" class="fw-bolder text-danger"> {{$inputData->contract_no}}</td>
                    <td>ເລີ່ມສັນຍາ: </td><td width="300" class="fw-bolder text-center"> {{Carbon::parse($inputData->start_date)->format('d/m/Y') . ' ຫາ '. Carbon::parse($inputData->end_date)->format('d/m/Y')}}</td>
                    <td>ໝົດສັນຍາໃນອີກ:</td><td>
                        @php
                            $startDate = Carbon::parse($inputData->end_date);
                            $endDate = Carbon::parse(now());
                            $result = $endDate->diffInDays($startDate,false);
                        @endphp
                            {{$result}}
                    </td>
                </tr>
    ...
    <div class="row">
        <div class="col-md-4">
            ...
            <div class="row pt-3">
                <div class="col-md-12">
                    ...
                    <div class="row mb-3">
                        <div class="col-md-12">
                            <h3 class="notosanLao">ຫຼັກຖານຈ່າຍເງິນ</h3>
                            <img src="{{$inputData->slip_confirmed}}" class="img-fluid">
                        </div>
                    </div>
                    {{-- Contronl button --}}
                    {{-- <div class="row">
        ...
        <div class="col-md-8">
            <h3 class="text-center notosanLao">ຂໍ້ມູນປະກັນໄພ</h3>
