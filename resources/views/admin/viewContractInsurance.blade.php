    ...
    <div class="row">
        <div class="col-md-12">
            <table class="notosanLao fs-4">
                <tr>
                    <td>ເລກທີສັນຍາ: </td><td class="fw-bolder text-danger"> {{$inputData->contract_no}}</td>
                    <td>ເລີ່ມສັນຍາ: </td><td class="fw-bolder text-center"> {{Carbon::parse($inputData->start_date)->format('d/m/Y') . ' ຫາ '. Carbon::parse($inputData->end_date)->format('d/m/Y')}}</td>
                </tr>
            </table>
        </div>
    </div>
