...
@section('content')
    ...
    <nav aria-label="breadcrumb">
        <ol class="breadcrumb notosanLao">
            ...
            <li class="breadcrumb-item active" aria-current="page">ຂໍ້ມູນຊັ້ນປະກັນໄພ</li>
        </ol>
    </nav>
    <hr>
    {{-- End Navigator bar --}}
    <h3 class="notosanLao text-center">ຂໍ້ມູນຊັ້ນປະກັນໄພ</h3>
                ...
                <tbody>
                    @foreach ($levels as $item)
                        <tr>
                            ...
                            <td>
                                <a onclick="callEditModal('{{ $item->id }}','{{ $item->name }}','{{ $item->menu_type }}')"
                                    data-bs-toggle="modal" data-bs-target="#editModal" class="btn btn-warning btn-sm"><i
